...
- 测试到核心服务：search.test.ts 直接测试 SearchService。
...
## 结论
useSearch 提供了简洁易用的搜索入口，SearchService 实现了稳定的基础匹配能力。当前版本聚焦于正确性与可维护性，具备清晰的扩展点，可按需引入索引、缓存、异步与高亮渲染优化，以满足更大规模与更高性能的搜索需求。
