...
- [GlobalSearch.vue:1-261](file://src/components/public-bar/GlobalSearch.vue#L1-L261)
- [use-archives.ts:1-193](file://src/composables/use-archives.ts#L1-L193)
- [use-tabs.ts:1-161](file://src/composables/use-tabs.ts#L1-L161)
- [use-search.ts:1-38](file://src/composables/use-search.ts#L1-L38)
- [file-tree.ts:1-87](file://src/core/file-tree.ts#L1-L87)
...
```mermaid
flowchart TD
Start(["进入组件"]) --> Init["初始化关键词与状态"]
Init --> WatchInput["监听输入变化"]
WatchInput --> Compute["计算搜索结果<br/>扁平化 + 过滤 + 耗时统计"]
...
## 结论
当前全局搜索实现了高效的文件名/路径级定位，并与标签页系统深度集成，具备良好的用户体验与扩展基础。核心服务层已具备全文检索能力，后续可在解析引擎与缓存机制完善后平滑接入内容级搜索，进一步提升检索能力与性能。
...
章节来源
- [GlobalSearch.test.ts:1-322](file://src/__tests__/components/GlobalSearch.test.ts#L1-L322)
