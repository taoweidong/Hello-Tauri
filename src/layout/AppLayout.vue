    ...
    <header class="app-header">
      ...
      <div class="header-right">
        ...
        <NTooltip trigger="hover">
          <template #trigger>
            <a href="https://github.com/username/hello-tauri" target="_blank" rel="noopener noreferrer" class="icon-link">
        ...
        <NTooltip trigger="hover">
          <template #trigger>
            <a href="https://github.com/username/hello-tauri/issues/new" target="_blank" rel="noopener noreferrer" class="icon-link">
